...
const MyProject = () => {
    ...
    return (
        <div className='m-20 gap-6'>
            ...
            <div className="mt-24 ">
                <a className='bg-red-600 p-3 rounded-md hover:bg-red-500' href="https://drive.google.com/file/d/1uv5qviGCDEUHyfpRxLvybYRBcBAUiEs5/view" download>
